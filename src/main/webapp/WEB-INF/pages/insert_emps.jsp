...
<h1 style="color: red; text-align: center">Fill The Employee
	Details</h1>

<form:form method="post" commandName="empCmd">
<table border="1">
<tr><td>
     Employee Id::</td><td><form:input path="eid" /><form:errors cssStyle="color:red" path="eid"/></td></tr>
<tr><td>                                   
	 Employee Name::</td><td><form:input path="ename" /><form:errors cssStyle="color:red" path="ename"/></td></tr>
	<tr><td>                                 
	 Employee Age::</td><td><form:input path="age" /><form:errors cssStyle="color:red" path="age"/></td></tr>
	<tr><td>                                     
