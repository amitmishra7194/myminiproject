...
<%--  <!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"> -->
 ...
 <h1 style="color: red; text-align: center">Fill The Student 
	Details</h1> 

<form:form method="post" commandName="studCmd"> 
 Student Id::<form:input path="sid" /><form:errors cssStyle="color:red" path="sid"/> 
<br>                                       
Student Name::<form:input path="sname" /><form:errors cssStyle="color:red" path="sname"/> 
<br>                                  
Student Age::<form:input path="sage"/><form:errors cssStyle="color:red" path="sage"/> 
<br>                                      
...
<div id="menu">
<ul><li><a href="list_studs.htm">StudentList</a></li><li>&nbsp;&nbsp;<a href="welcome.htm">Home</a> </li></ul>
 <br>
</div>
<table cellpadding=7px>
<caption><h1 style="color:#113d84;text-align:center;border-bottom:2px solid #113d84;width:450px">Registration Form &nbsp;&nbsp;&nbsp;
<h3 style="color:red"> ${result}</h3></h1>
<form:form method="POST" commandName="studCmd">
</caption>
<tr><td>Student Number ::</td><td><form:input path="sid" /></td></tr>
