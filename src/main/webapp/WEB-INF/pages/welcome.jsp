...
<body>
	...
	<div id="main">
		...
		<div id="menu">
			<ul>
				<li><a href="about_us.htm">AboutUs</a></li>
	...
	<div id="container">
		...
		<div class="login">
			<img src="javalogo.png" height="100px">&nbsp;&nbsp; <img
				src="james.jpg" height="100px">&nbsp;&nbsp; <img
				src="rodJonson.jpg" height="100px">&nbsp;&nbsp; <img
				src="DanBecker.jpg" height="100px">&nbsp;&nbsp; <img
				src="gavinking.jpg" height="100px">&nbsp;&nbsp;
		...
		<p>Java is a programming language and computing platform first
			...
			more are created every day. Java is fast, secure, and reliable. From
			laptops to datacenters, game consoles to scientific supercomputers,
			cell phones to the Internet, Java is everywhere!</p>

		<br> <br>
		<div id="footer">Copyright &copy; 1999-2017 by Amit Mishra. All
			Rights Reserved.</div>
	</div>
